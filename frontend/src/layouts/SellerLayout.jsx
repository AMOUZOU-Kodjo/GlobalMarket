...
export default function SellerLayout() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-2" aria-label="Navigation vendeur">
    ...
    <div className="min-h-screen flex bg-base-200">
      ...
      >
        ...
        <button
          ...
          className="absolute top-6 z-10 btn btn-circle btn-sm btn-primary shadow-md hidden lg:flex items-center justify-center"
          style={{ right: '-12px' }}
