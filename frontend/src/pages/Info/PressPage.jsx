...
export default function PressPage() {
  return (
    <InfoPage
      title="Presse"
      subtitle="Dernières actualités et communiqués de MarcoStore"
      sections={[
        {
          title: 'Communiqués récents',
          items: [
            { title: 'MarcoStore lève 15 millions d\'euros en Série A', description: '23 juin 2026 — Le tour de financement sera utilisé pour accélérer le développement technologique et l\'expansion en Afrique francophone.' },
            ...
            { title: 'MarcoStore dépasse le cap des 100 000 utilisateurs', description: '2 avril 2026 — Un jalon majeur atteint en seulement 18 mois d\'activité, porté par une croissance organique de 40% mois sur mois.' },
...
Kit presse disponible : logo haute résolution, photos de l'équipe, infographies et chiffres clés.`,
        },
        {
          ...
          content: `MarcoStore a été cité dans :

• Les Echos — « La startup qui veut démocratiser l'e-commerce en Afrique »
• TechCrunch — « MarcoStore: the French marketplace challenger »
